...
def write_results(prediction, confidence, num_classes, nms=True, nms_conf=0.4):
    ...
    for ind in range(batch_size):
        ...
        seq = (image_pred, max_conf, max_conf_score)
        image_pred = torch.cat(seq, 1)

        # Get rid of the zero entries
        non_zero_ind = (torch.nonzero(image_pred[:, 4]))

        image_pred_ = image_pred[non_zero_ind.squeeze(), :].view(-1, 87)
        ...
        for cls in img_classes:
            ...
            image_pred_class = image_pred_[class_mask_ind].view(-1, 87)
            ...
            if nms:
                ...
                for i in range(idx):
                    ...
                    image_pred_class = image_pred_class[non_zero_ind].view(-1, 87)
